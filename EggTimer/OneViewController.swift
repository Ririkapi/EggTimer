...
class OneViewController: UIViewController {
    ...
    let noodleTime: TimeInterval = 60
    ...
    @objc func tickTimer(_ timer: Timer) {
        ...
        if self.lbTimer.text == "00:00"{
            ...
            let alert = UIAlertController(title: "1minute", message:
